...
export default function VenueDetailPage() {
  ...
  const [selectedSpace, setSelectedSpace] = useState(venueData.spaces[0])
              ...
              <CardContent>
                <div className="grid gap-4">
                  {venueData.spaces.map((space) => (
                    <div key={space.id} className="border border-slate-200 rounded-lg p-4">
              ...
              <CardContent className="space-y-4">
                ...
                <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
                  <DialogTrigger asChild>
                    <Button className="w-full bg-primary-500 hover:bg-primary-600 text-white" size="lg">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input id="customer-name" placeholder="Enter your name" className="border-slate-200" />
                        </div>
                        <div className="space-y-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="customer-phone" placeholder="+44 123 456 7890" className="border-slate-200" />
                      </div>
